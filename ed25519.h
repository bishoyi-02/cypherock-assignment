...
void ed25519_sign_ext(const unsigned char *m, size_t mlen,
...
void curve25519_scalarmult_basepoint(curve25519_key mypublic,
...
void ed25519_cosi_combine_signatures(ed25519_signature res,
                                     ...
                                     size_t n);
void ed25519_cosi_commit(ed25519_secret_key nonce,
                         ed25519_public_key commitment);
int ed25519_cosi_sign(const unsigned char *m, size_t mlen,
                      const ed25519_secret_key key,
                      const ed25519_secret_key nonce,
                      const ed25519_public_key R, const ed25519_public_key pk,
